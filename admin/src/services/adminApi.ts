...
export const settingsApi = {
  ...
  updateSettings: async (data: any): Promise<any> => {
    const response = await apiClient.patch<ApiResponse<any>>('/settings/admin/settings', data);
    return extractData(response);
  },
};
...
(adminApi as any).updateSettings = (data: any) => (adminApi as any).settings.updateSettings(data);
